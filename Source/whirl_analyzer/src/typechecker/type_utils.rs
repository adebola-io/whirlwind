...
//             let eval = TypeEval::ModelInstance {
...
//                 ScopeEntry::Function(_) => Ok(TypeEval::ModelInstance {
//                     model_address: address,
...
// //     match &typeval {
// //         TypeEval::ModelInstance { .. } | TypeEval::MethodOfInstance { .. } => {
// //             Err(value_as_type(span))
// //         }
...
//                 }
//             }
//             return Ok(TypeEval::ModelInstance {
//                 model_address: address,
//                 args: None,
//             });
//         }
